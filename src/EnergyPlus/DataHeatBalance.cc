...
=======
	int const IntGainTypeOf_SecCoolingDXCoilSingleSpeed( 46 );
	int const IntGainTypeOf_SecHeatingDXCoilSingleSpeed( 47 );
	int const IntGainTypeOf_SecCoolingDXCoilTwoSpeed( 48 );
	int const IntGainTypeOf_SecCoolingDXCoilMultiSpeed( 49 );
	int const IntGainTypeOf_SecHeatingDXCoilMultiSpeed( 50 );
